    ...
    return (
        <div className="pt-40 pb-24 max-w-4xl mx-auto px-6">
            ...
            <div className="prose prose-zinc max-w-none space-y-8 text-zinc-600">
                <section>
                    <h2 className="text-2xl font-bold text-secondary uppercase italic">1. Informazioni Generali</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-secondary uppercase italic">2. Titolare del Trattamento</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-secondary uppercase italic">3. Tipi di Dati Trattati</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-secondary uppercase italic">4. Finalità del Trattamento</h2>
