    ...
    return (
        <div className="pt-40 pb-24 max-w-4xl mx-auto px-6">
            ...
            <div className="prose prose-zinc prose-invert max-w-none space-y-8 text-zinc-400">
                <section>
                    <h2 className="text-2xl font-bold text-white uppercase italic">1. Accettazione dei Termini</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-white uppercase italic">2. Utilizzo del Sito</h2>
                ...
                <section>
                    <h2 className="text-2xl font-bold text-white uppercase italic">3. Responsabilità</h2>
