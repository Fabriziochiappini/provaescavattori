    ...
    <div className="pt-32 pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-24 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-xl text-zinc-600 leading-relaxed font-light mb-8">
              Dal 1998, Contegroup è il punto di riferimento per le imprese che cercano affidabilità nel movimento terra. Nati come piccola officina, oggi siamo leader nel centro-sud Italia con un parco macchine di oltre 500 unità.
            </p>
            <div className="flex gap-4">
              <div className="bg-zinc-100 p-6 rounded-2xl">
                <p className="text-4xl font-black text-black">25+</p>
                <p className="text-zinc-500 text-xs font-bold uppercase tracking-widest">Anni di attività</p>
              </div>
              <div className="bg-zinc-100 p-6 rounded-2xl">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-10 -left-10 bg-white p-10 rounded-3xl shadow-2xl border border-zinc-100 max-w-xs hidden md:block">
              <p className="italic text-zinc-500">"Non vendiamo solo macchine, vendiamo la certezza che il tuo cantiere non si fermerà mai."</p>
              <p className="font-bold mt-4">— Antonio Conte, Fondatore</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 border-y border-zinc-200 grid grid-cols-1 md:grid-cols-3 gap-16">
          {[
            { icon: Target, title: "Mission", text: "Fornire le migliori tecnologie per il movimento terra, ottimizzando tempi e costi per i nostri partner." },
            { icon: Eye, title: "Vision", text: "Diventare il leader nazionale nell'integrazione di tecnologie autonome e sostenibili per l'edilizia." },
            { icon: Award, title: "Qualità", text: "Manteniamo i più alti standard di manutenzione e sicurezza su ogni singolo bullone dei nostri mezzi." }
          ].map((val, i) => (
        ...
        <section className="py-24">
          ...
          <div className="space-y-12 max-w-4xl mx-auto">
            {[
              { year: "1998", event: "Fondazione a Roma da parte di Antonio Conte con focus sulla riparazione." },
              { year: "2005", event: "Inizio dell'attività di rivendita ufficiale per i principali marchi mondiali." },
              { year: "2012", event: "Lancio del servizio di noleggio flotta con 50 mezzi iniziali." },
              { year: "2020", event: "Apertura della sede logistica 4.0 con officina robotizzata." },
              { year: "2024", event: "Leader nel centro Italia con oltre 1000 clienti attivi." }
            ].map((step, i) => (
